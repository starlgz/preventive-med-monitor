...
class TalentPolicyExtractor:
    ...
    TALENT_INTRO_PATTERNS = [
        ...
        r"鹅城英才", r"500精英计划", r"绿扬金凤", r"金华引才", r"海陵英才",
        r"彭城英才", r"双龙引才", r"侨都英才", r"江门人才", r"徐州英才", r"金华英才",
        r"仙境英才", r"河洛英才", r"烟台英才", r"洛阳英才", r"鸢都英才", r"潍坊英才", r"保定英才",
        r"蒙山英才", r"沂蒙英才", r"临沂英才", r"临沂人才", r"凤凰英才", r"唐山英才", r"唐山凤凰英才",
        r"圣地英才", r"太白英才", r"济宁英才", r"济宁人才", r"赵都英才", r"邯郸英才", r"邯郸人才"
    ]
