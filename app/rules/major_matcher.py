...
class MajorMatcher:
    ...
    SUB_DISCIPLINE_KEYWORDS = {
        ...
        "突发中毒应急与毒物快速筛查": ["突发中毒应急", "毒物快速筛查", "中毒现场应急检测", "不明毒物检测", "毒物快检技术", "急性中毒危害评估"],
        "辐射危害监测与放射卫生防护": ["辐射危害监测", "放射卫生防护", "放射诊疗辐射监测", "核与辐射卫生应急", "放射性污染检测", "职业性放射病监测"],
        "环境暴露组学与健康风险评估": ["环境暴露组学", "健康风险评估", "暴露组学", "环境污染物暴露", "人群健康风险评估", "环境致病因子评估"],
        "消毒学与院感传播阻断": ["消毒学", "院感传播阻断", "环境消毒评价", "医院感染传播阻断", "消毒剂效果评价", "院内感染传播溯源"],
        "空间流行病学与疾病制图": ["空间流行病学", "疾病制图", "GIS公卫应用", "空间点模式分析", "空间自相关分析", "疾病空间聚集性", "遥感公卫监测"],
        "病原质谱快速鉴定与色谱分析": ["病原质谱快速鉴定", "病原质谱鉴定", "MALDI-TOF质谱", "飞行时间质谱", "气相色谱质谱联用", "液相色谱质谱联用", "靶向质谱筛查", "毒物色谱分析"]
    }
