...
class MajorMatcher:
    ...
    SUB_DISCIPLINE_KEYWORDS = {
        ...
        "劳动卫生与环境卫生学": ["劳动卫生与环境卫生", "劳动卫生", "环境卫生", "职业卫生", "职业病防治", "环境流行病学", "辐射卫生", "职业健康", "职业卫生评价", "环境与健康", "环境暴露学", "劳动生理"],
        "流行病与卫生统计学": ["流行病与卫生统计", "流行病学", "卫生统计学", "现场流行病学", "传染病流行病学", "慢性病流行病学", "空间流行病学", "分子流行病学", "临床流行病学", "健康大数据统计", "生物统计与流行病", "基因流行病学"],
        "卫生检验与检疫": ["卫生检验与检疫", "卫生检验", "检验检疫", "病原检验", "微生物检验", "卫生理化检验", "理化检验", "分子生物学检验", "病毒检验", "细菌检验", "水质理化检验", "食品理化检验", "空气理化检验"],
        "卫生监督": ["卫生监督", "公共卫生监督", "医疗监督", "卫生执法", "卫生行政执法", "卫生监督与行政执法", "卫生法制监督"],
        "生物统计学": ["生物统计学", "生物统计", "生物信息学", "医学统计", "统计与生物信息", "应用统计学(生物统计方向)", "生物信息与统计"],
        "全球健康学": ["全球健康学", "全球健康", "全球卫生", "国际卫生", "国际健康", "Global Health", "国际卫生与全球健康", "全球公共卫生"],
        "医院感染控制": ["医院感染控制", "医院感染管理", "院感", "感控", "感染控制", "消毒与病媒生物防制", "病媒生物防制", "医院感染监控"],
