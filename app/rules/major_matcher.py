...
class MajorMatcher:
    ...
    SUB_DISCIPLINE_KEYWORDS = {
        "预防医学核心": ["预防医学", "公共卫生与预防医学", "公共卫生", "公卫医师", "MPH", "公共卫生硕士", "现场流行病学", "FETP", "预防医", "公卫"],
        "流行病与卫生统计学": ["流行病与卫生统计", "流行病学", "卫生统计学", "现场流调", "传染病流行病", "慢性病流行病", "分子流行病", "空间流行病", "临床流行病", "数字公卫", "动力学建模", "流调员", "流病", "卫统"],
        ...
        "卫生检验与检疫": ["卫生检验与检疫", "卫生检验", "理化检验", "微生物检验", "病原检验", "检验检疫", "水质理化", "空气理化", "食品理化检验", "卫检"],
        ...
        "疾病控制与应急处置": ["疾病预防控制", "传染病防制", "慢病防制", "免疫规划", "计划免疫", "艾滋病防治", "结核病防治", "地方病防治", "突发公共卫生事件应急", "消毒与病媒生物防制", "院感控制", "免规", "结防", "艾防", "消杀", "冷链"]
    }
    ...
    def calculate_match_score(
        ...
        # 4. 专业得分 S_专业 (满分 50)
        s_major = 0
        if matched_codes or any(kw in text for kw in ["预防医学", "公共卫生与预防医学", "公共卫生硕士", "MPH", "1004", "1053", "520601"]):
            s_major = 50
            evidence_chain.append("专业要求明确锁定预防医学/公卫核心学科 (满分50)")
        elif any(kw in text for kw in ["流行病", "卫生统计", "卫生检验", "食品卫生", "环境卫生", "劳动卫生", "妇幼保健", "妇幼保健医学", "儿少卫生", "卫生毒理", "卫生监督", "520602", "520603", "520604", "520507"]):
            s_major = 42
            evidence_chain.append("专业要求命中公卫二级学科/检验/毒理/流统/高职公卫 (得分42)")
